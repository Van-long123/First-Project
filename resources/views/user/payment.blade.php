                ...
                <div class="col-12">
                    <div class="info-user">
                        ...
                        <div class="info">
                            ...
                            <a href="{{route('info_update')}}" class="info-change">Thay đổi</a>
                        </div>
                    </div>
                </div>
              </div>
                        ...
                        @foreach ($product as $value)
                          <div class="cart-product">
                            <div class="cart-body">
                              ...
                              <div class="cart-sl">
                                <span>{{$value->quanlity}}</span>
                              </div>
                              <div class="cart-tt ms-2">
                                <span class="cart-tt-price">{{$product->count()===1 ? $value->price : $value->price*$value->quanlity}}</span><sup style="color: #FF424E;">đ</sup>
                              </div>
                              <div class="cart-img">
                          ...
                          @php 
                              $total+= $product->count()===1 ? $value->price : $value->price*$value->quanlity
                          @endphp
                        @endforeach
